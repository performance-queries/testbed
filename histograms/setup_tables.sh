...
do
    im1=$((i-1))
    choice=$((2 + i % 2))
    port=$((senders+choice - 1))
    echo "table_add ipv4_match Set_nhop 10.0.${im1}.10/32 => 10.${choice}.0.1 $port" >> $cmdfile
done
echo "table_add dmac Set_dmac 10.2.0.1 => 00:aa:bb:00:01:00" >> $cmdfile
echo "table_add smac Set_smac $((senders+1)) => 00:aa:bb:00:00:$(printf %02x $senders)" >> $cmdfile
echo "table_add dmac Set_dmac 10.3.0.1 => 00:aa:bb:00:02:00" >> $cmdfile
echo "table_add smac Set_smac $((senders+2)) => 00:aa:bb:00:00:$(printf %02x $((senders+1)))" >> $cmdfile
