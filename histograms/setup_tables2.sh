...
echo "table_add dmac Set_dmac 10.1.0.1 => 00:aa:bb:00:00:$(printf %02x $senders)" >> $cmdfile
echo "table_add smac Set_smac 1 => 00:aa:bb:00:01:00" >> $cmdfile
...
echo "table_add dmac Set_dmac 10.4.0.1 => 00:aa:bb:00:03:$(printf %02x $rcvrs)" >> $cmdfile
echo "table_add smac Set_smac 2 => 00:aa:bb:00:01:01" >> $cmdfile
